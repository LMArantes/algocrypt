...
des = st.Page("modern-symmetric-key-algorithms/block-ciphers/data_encryption_standard.py", title="DES")
triple_des = st.Page("modern-symmetric-key-algorithms/block-ciphers/triple_des.py", title="3DES")
aes = st.Page("modern-symmetric-key-algorithms/block-ciphers/advanced_encryption_standard.py", title="AES")
blowfish = st.Page("modern-symmetric-key-algorithms/block-ciphers/blowfish.py", title="Blowfish")
twofish = st.Page("modern-symmetric-key-algorithms/block-ciphers/twofish.py", title="Twofish")
rc6 = st.Page("modern-symmetric-key-algorithms/block-ciphers/r6.py", title="RC6")


# Modern Symmetric-Key Algorithms (Stream Ciphers)
rc4 = st.Page("modern-symmetric-key-algorithms/stream-ciphers/rc4.py", title="RC4")
chacha20 = st.Page("modern-symmetric-key-algorithms/stream-ciphers/chacha20.py", title="ChaCha20")
salsa20 = st.Page("modern-symmetric-key-algorithms/stream-ciphers/salsa20.py", title="Salsa20")


# Asymmetric Encryption (Public-key cryptography)
rsa = st.Page("asymmetric-encryption/rivest_shamir_adleman.py", title="RSA")
dh = st.Page("asymmetric-encryption/diffie_hellman.py", title="Diffie-Hellman (DH)")
ecc = st.Page("asymmetric-encryption/elliptic_curve_cryptography.py", title="Elliptic Curve Cryptography (ECC)")
elgamal = st.Page("asymmetric-encryption/elgamal.py", title="ElGamal")
